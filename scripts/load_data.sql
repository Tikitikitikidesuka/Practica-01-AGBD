...
LOAD XML LOCAL INFILE 'directorio_datos/MegaDrive.xml'
	INTO TABLE juegos
...
LOAD XML LOCAL INFILE 'directorio_datos/Nintendo.xml'
	INTO TABLE juegos
	ROWS IDENTIFIED BY '<game>'
...
LOAD XML LOCAL INFILE 'directorio_datos/GameBoy.xml'
	INTO TABLE juegos
	ROWS IDENTIFIED BY '<game>'
