...
Se puede observar que el proceso es muchísimo más lento si se crean las claves tras la inserción de los datos. Con la solución óptima se tarda ligeramente más (377.4 ms en nuestro caso) en cargar los datos que si no se hubiesen creado las claves primero, debido a que se tiene que ir comprobando las restricciones y actualizando los índices a medida que se va insertando. Pero, a cambio, la creación de las claves es muy veloz. Crear las claves una vez se han insertado los datos es un proceso muy costoso
