...
Ambas sentencias requieren la especificación de un mapeo de los tipos de los ficheros a las columnas de la base de datos. El único misterio de este problema es la necesidad de transformar el formato de las fechas de cadenas de carácteres a tipos \mintinline{mysql}{DATE} de MySQL y de sumar el valor correspondiente a los ids como se especificó en el anexo.
