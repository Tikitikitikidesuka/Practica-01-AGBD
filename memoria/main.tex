...
En el fichero `/etc/mysql/my.cnf` dentro del contendor de MariaDB, es necesario añadir la siguiente linea donde se encuentran las sentencias de \emph{innodb}:\mininline{shell-session}{innodb_page_size = <tamaño_de_página>}. En nuestro caso \mininline{shell-session}{tamaño_de_página} valdrá: \mintinline{shell-session}{4k, 16k y 64k} (Importante la k en minúscula). El buffer ya venía preconfigurado con un tamaño razonable de 246 Mb.
...
4 KB                                & 28.8 MB                                    & 251.0 ms                                 \\
16 KB                               & 26.8 MB                                    & 235.7 ms                                 \\
64 KB                               & 30.5 MB                                    & 216.8 ms                                
\end{tabular}
\end{table}
